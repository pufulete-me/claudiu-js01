...
console.log(`Suprafata totala este: ${firstSurface + secondSurface}cm patrati`);
...
console.log(`Suprafata unui dreptunghi cu dimensiunile de 12 si 9 este ${calculateRectangleArea(12, 9)}`);
...
console.log(`aria unui patrat este: ${calculateRectangleArea(8, 8)}.`);
